...
#ifndef _S32K312_DEVICE_H_
#define _S32K312_DEVICE_H_
...
// these are all message buffer status registers...

/* The count of CAN_CS */
#define CAN_CS_COUNT_MB8B (64U)//(96U)

/* The count of CAN_ID */
#define CAN_ID_COUNT_MB8B (64U)//(96U)

/* The count of CAN_WORD */
#define CAN_WORD_COUNT_MB8B (64U)//(96U)
...
#define CAN_RXIMR_COUNT (64U)//(96U)
...
#define CAN_HR_TIME_STAMP_COUNT (64U)//(96U)
...
// see if I can fix conflict?
#define DMA_Type	ZephyrDMA_Type
...
typedef struct
{
    ...
    //#warning "FIX ME: S32K312: DMA size"
    // S32K312 and S32K311 are identical -- they have only 12 channels, no offset channels
    // that doesn't mean the above is correct though...
#if 0
    CH[148]; /* Channels from 12 -> 127 are offset channels */
#else
	CH[12]; /* S32K312: only 12 channels (0-11) */
#endif
} DMA_Type;

// NOTE: some of these constants may need to remove the 'e' from the front of them (see S32K312_DMA.h
