...
#ifndef _S32K312_FEATURES_H_
#define _S32K312_FEATURES_H_
...
#define FSL_FEATURE_SOC_LPUART_COUNT (8)//(16)
/* @brief FLEXCAN availability on the SoC. */
#define FSL_FEATURE_SOC_FLEXCAN_COUNT (6)//(6)
/* @brief LPI2C availability on the SoC. */
#define FSL_FEATURE_SOC_LPI2C_COUNT (2)
/* @brief LPSPI availability on the SoC. */
#define FSL_FEATURE_SOC_LPSPI_COUNT (4)//(6)
...
#define FSL_FEATURE_DMAMUX_MODULE_CHANNEL (8)//(16)
...
/* @brief Code flash (PFLASH) has 2 blocks of 1 MiB each total size = 2 MiB */
