...
/*!
 * @file S32K312_TRGMUX.h
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_TRGMUX
 *
...
#if !defined(S32K312_TRGMUX_H_)  /* Check if memory map has not been already included */
#define S32K312_TRGMUX_H_
...
#endif  /* #if !defined(S32K312_TRGMUX_H_) */
