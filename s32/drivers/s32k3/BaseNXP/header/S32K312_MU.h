 ...
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_MU
 *
...
#if !defined(S32K312_MU_H_)  /* Check if memory map has not been already included */
#define S32K312_MU_H_
...
#define IP_MU_1__MUB_BASE                        (0x40390000u)
...
#endif  /* #if !defined(S32K312_MU_H_) */
