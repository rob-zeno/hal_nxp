...
#if !defined(S32K312_COMMON_H_)  /* Check if memory map has not been already included */
#define S32K312_COMMON_H_
#define MCU_S32K312

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
#define MCU_ACTIVE barf!
  #error S32K312 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  STCU_MBIST_IRQn              = 191,              /**< Interrupt request(miscellaneous conditions) */
...
#endif  /* #if !defined(S32K312_COMMON_H_) */
