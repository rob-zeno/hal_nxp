 ...
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_MSCM
 *
...
#if !defined(S32K312_MSCM_H_)  /* Check if memory map has not been already included */
#define S32K312_MSCM_H_
...
#define MSCM_XN_CTRL_SRAM0_XN_WIDTH              (1U)
...
#define MSCM_XN_CTRL_SRAM1_XN_WIDTH              (1U)
...
#define MSCM_XN_CTRL_ITCM0_XN_WIDTH              (1U)
...
#define MSCM_XN_CTRL_ITCM1_XN_WIDTH              (1U)
...
#define MSCM_XN_CTRL_ITCM0_BK_XN_WIDTH           (1U)
...
#define MSCM_XN_CTRL_ITCM1_BK_XN_WIDTH           (1U)
...
#define MSCM_XN_CTRL_DTCM0_XN_WIDTH              (1U)
...
#define MSCM_XN_CTRL_DTCM1_XN_WIDTH              (1U)
...
#define MSCM_XN_CTRL_DTCM0_BK_XN_WIDTH           (1U)
...
#define MSCM_XN_CTRL_DTCM1_BK_XN_WIDTH           (1U)
...
#define MSCM_ENEDC_EN_ADD_DMA_S0_WIDTH           (1U)
...
#define MSCM_ENEDC_EN_ADD_DMA_S1_WIDTH           (1U)
...
#endif  /* #if !defined(S32K312_MSCM_H_) */
