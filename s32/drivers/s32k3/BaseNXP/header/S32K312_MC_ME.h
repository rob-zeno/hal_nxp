...
/*!
 * @file S32K312_MC_ME.h
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_MC_ME
 *
...
#if !defined(S32K312_MC_ME_H_)  /* Check if memory map has not been already included */
#define S32K312_MC_ME_H_
...
#define MC_ME_PRTN1_COFB3_STAT_BLOCK100_WIDTH    (1U)
...
#define MC_ME_PRTN1_COFB3_STAT_BLOCK109_WIDTH    (1U)
...
#endif  /* #if !defined(S32K312_MC_ME_H_) */
