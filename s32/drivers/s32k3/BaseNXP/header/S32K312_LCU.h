 ...
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_LCU
 *
...
#if !defined(S32K312_LCU_H_)  /* Check if memory map has not been already included */
#define S32K312_LCU_H_
...
#endif  /* #if !defined(S32K312_LCU_H_) */
