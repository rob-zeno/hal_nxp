...
/*!
 * @file S32K312_MC_CGM.h
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_MC_CGM
 *
...
#if !defined(S32K312_MC_CGM_H_)  /* Check if memory map has not been already included */
#define S32K312_MC_CGM_H_
...
#endif  /* #if !defined(S32K312_MC_CGM_H_) */
