 ...
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_XBIC
 *
...
#if !defined(S32K312_XBIC_H_)  /* Check if memory map has not been already included */
#define S32K312_XBIC_H_
...
#define IP_XBIC_BASE_ADDRS                       { IP_XBIC_AXBS_BASE }
/** Array initializer of XBIC peripheral base pointers */
#define IP_XBIC_BASE_PTRS                        { IP_XBIC_AXBS }
...
#endif  /* #if !defined(S32K312_XBIC_H_) */
