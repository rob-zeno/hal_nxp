 ...
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_STM
 *
...
#if !defined(S32K312_STM_H_)  /* Check if memory map has not been already included */
#define S32K312_STM_H_
...
#define IP_STM_BASE_ADDRS                        { IP_STM_0_BASE }
/** Array initializer of STM peripheral base pointers */
#define IP_STM_BASE_PTRS                         { IP_STM_0 }
...
#endif  /* #if !defined(S32K312_STM_H_) */
