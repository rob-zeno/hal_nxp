 ...
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_XRDC
 *
...
#if !defined(S32K312_XRDC_H_)  /* Check if memory map has not been already included */
#define S32K312_XRDC_H_
...
#define XRDC_PDAC_SLOT_COUNT                      2u
#define XRDC_MRCN_MRGDN_COUNT                     8u
#define XRDC_MRCN_COUNT                           2u
...
typedef struct {
  ...
  uint8_t RESERVED_11[2048];
  struct {                                         /* offset: 0x2000, array step: 0x200 */
    ...
    } MRGDN[XRDC_MRCN_MRGDN_COUNT];
    uint8_t RESERVED_0[256];
  } MRCN[XRDC_MRCN_COUNT];
...
#define XRDC_MDA_W0_0_DFMT0_DID_MASK             (0x1U)
#define XRDC_MDA_W0_0_DFMT0_DID_SHIFT            (0U)
#define XRDC_MDA_W0_0_DFMT0_DID_WIDTH            (1U)
...
#define XRDC_MDA_W0_1_DFMT1_DID_MASK             (0x1U)
#define XRDC_MDA_W0_1_DFMT1_DID_SHIFT            (0U)
#define XRDC_MDA_W0_1_DFMT1_DID_WIDTH            (1U)
...
#define XRDC_MDA_W0_2_DFMT1_DID_MASK             (0x1U)
#define XRDC_MDA_W0_2_DFMT1_DID_SHIFT            (0U)
#define XRDC_MDA_W0_2_DFMT1_DID_WIDTH            (1U)
...
#define XRDC_MDA_W0_3_DFMT0_DID_MASK             (0x1U)
#define XRDC_MDA_W0_3_DFMT0_DID_SHIFT            (0U)
#define XRDC_MDA_W0_3_DFMT0_DID_WIDTH            (1U)
...
#endif  /* #if !defined(S32K312_XRDC_H_) */
