...
/*!
 * @file S32K312_LPCMP.h
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_LPCMP
 *
...
#if !defined(S32K312_LPCMP_H_)  /* Check if memory map has not been already included */
#define S32K312_LPCMP_H_
...
#define LPCMP_INSTANCE_COUNT                     (2u)
...
#define IP_LPCMP_BASE_ADDRS                      { IP_LPCMP_0_BASE, IP_LPCMP_1_BASE }
/** Array initializer of LPCMP peripheral base pointers */
#define IP_LPCMP_BASE_PTRS                       { IP_LPCMP_0, IP_LPCMP_1 }
...
#endif  /* #if !defined(S32K312_LPCMP_H_) */
