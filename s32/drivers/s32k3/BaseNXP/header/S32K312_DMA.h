 ...
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_DMA
 *
...
#if !defined(S32K312_DMA_H_)  /* Check if memory map has not been already included */
#define S32K312_DMA_H_
...
#define DMA_CSR_ACTIVE_ID_MASK                   (0xF000000U)
#define DMA_CSR_ACTIVE_ID_SHIFT                  (24U)
#define DMA_CSR_ACTIVE_ID_WIDTH                  (4U)
...
#define DMA_ES_ERRCHN_MASK                       (0xF000000U)
...
#define DMA_INT_INT_MASK                         (0xFFFU)
#define DMA_INT_INT_SHIFT                        (0U)
#define DMA_INT_INT_WIDTH                        (12U)
...
#endif  /* #if !defined(S32K312_DMA_H_) */
