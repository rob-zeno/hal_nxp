...
/*!
 * @file S32K312_PRAMC.h
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_PRAMC
 *
...
#if !defined(S32K312_PRAMC_H_)  /* Check if memory map has not been already included */
#define S32K312_PRAMC_H_
...
#define IP_PRAMC_BASE_ADDRS                      { IP_PRAMC_0_BASE }
/** Array initializer of PRAMC peripheral base pointers */
#define IP_PRAMC_BASE_PTRS                       { IP_PRAMC_0 }
...
#endif  /* #if !defined(S32K312_PRAMC_H_) */
