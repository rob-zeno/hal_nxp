...
/*!
 * @file S32K312_FLEXCAN.h
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_FLEXCAN
 *
...
#if !defined(S32K312_FLEXCAN_H_)  /* Check if memory map has not been already included */
#define S32K312_FLEXCAN_H_
...
#define FLEXCAN_HR_TIME_STAMP_COUNT               64u
...
#endif  /* #if !defined(S32K312_FLEXCAN_H_) */
