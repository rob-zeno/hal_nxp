 ...
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_ADC
 *
...
#if !defined(S32K312_ADC_H_)  /* Check if memory map has not been already included */
#define S32K312_ADC_H_
...
#endif  /* #if !defined(S32K312_ADC_H_) */
