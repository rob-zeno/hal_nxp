 ...
 * @version 1.4
 * @date 2022-06-20
 * @brief Peripheral Access Layer for S32K312_STCU
 *
...
#if !defined(S32K312_STCU_H_)  /* Check if memory map has not been already included */
#define S32K312_STCU_H_
...
#define STCU_LBRMSW0_LBRMSW0_WIDTH               (1U)
...
#endif  /* #if !defined(S32K312_STCU_H_) */
